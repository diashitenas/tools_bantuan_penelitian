import { actionLoadScene, actionShortcuts, actionClearCanvas } from "../../actions";
...
import { HelpIcon, LoadIcon, usersIcon, PlusIcon } from "../icons";
...
const MenuItemNewCanvas = () => {
  ...
  return (
    <WelcomeScreenMenuItem
      onSelect={() => actionManager.executeAction(actionClearCanvas)}
      shortcut={null}
      icon={PlusIcon}
    >
      {t("labels.clearCanvas")}
    </WelcomeScreenMenuItem>
  );
};
MenuItemNewCanvas.displayName = "MenuItemNewCanvas";
...
Center.MenuItemNewCanvas = MenuItemNewCanvas;
